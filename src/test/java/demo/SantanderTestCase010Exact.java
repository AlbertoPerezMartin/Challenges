...
public class SantanderTestCase010Exact {
	public static void main(String[] args) {
		...
		try {
			...
			chromeDriver.findElement(By.cssSelector("a[href*=\"https://locations.santanderbank.com/search.html")).click();
			chromeDriver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));
					
			//Step 3. Ensure the 4 boxes exist and are enabled // None of them exist, because is the wrong page but I'm still gonna look, WILL FAIL
			...
			//Step 4. Click the "Select" button for "Everyday Banking" //WILL FAIL, button doesn't exist
			...
			//Step 5. Enter Zip Code "07733" on the search box and press enter //At this point it should work because the page works just as the intended one but the process has already failed
			WebElement input = chromeDriver.findElement(By.id("search-location-input"));
			input.sendKeys("07733");
			input.sendKeys(Keys.ENTER);
			
			//Step 6. Validate there are 4 branch boxes and one of the belongs to "Hazlet" //This time there'll be a lot more boxes and at least one of them has the Hazlet name but it's not what's expected, WILL FAIL
